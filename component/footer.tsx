 ...
 * - The logo is the existing coloured /Derma+Solutions+Logo.webp turned solid
...
export default function SiteFooter() {
  return (
    <footer className="w-full bg-[#131313] px-6 pb-16 pt-14 text-white sm:px-10 lg:px-[60px] lg:pb-[50px] lg:pt-[50px]">
      <div className="mx-auto grid max-w-[1900px] grid-cols-1 gap-10 lg:grid-cols-2 lg:items-start lg:gap-4">
        ...
        {/* details */}
        <div>
          <h2 className="text-[26px] leading-10 text-white sm:text-[33px]">
            {content.name}
          </h2>

          <p className="mt-6 max-w-[882px] text-[17px] leading-[31px] text-[#F2F2F2] sm:text-[20.4px] lg:mt-[22px]">
            {content.address}
          </p>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-x-4 gap-y-1 text-[15px] leading-[31px] text-[#F2F2F2] sm:text-[16px] md:flex-nowrap md:text-[18px] lg:mt-[17px] lg:text-[clamp(12px,1.1vw,20.4px)]">
            <p className="md:whitespace-nowrap">{content.copyright}</p>
