...
import { Dialog, DialogContent, DialogTitle, DialogDescription } from "@/component/ui/dialog"
...
export function CameraModal({ open, onOpenChange, onCapture }: CameraModalProps) {
  ...
  useEffect(() => {
    // Resets local capture/stream state to match the `open` prop from the parent dialog.
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="hairscan-theme border-primary/20 bg-card/95 p-0 backdrop-blur-xl sm:max-w-lg"
      >
            ...
            {error ? (
              ...
              <>
                ...
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <div className="relative h-64 w-64 rounded-full border-4 border-primary/60 shadow-[0_0_30px_rgba(201,144,69,0.3),inset_0_0_30px_rgba(201,144,69,0.1)]">
                ...
                {isStreaming && (
                  <div className="pointer-events-none absolute inset-x-0 top-0 h-full overflow-hidden">
                    <div className="animate-scan absolute left-1/2 h-1 w-64 -translate-x-1/2 bg-gradient-to-r from-transparent via-primary to-transparent opacity-80 shadow-[0_0_20px_rgba(201,144,69,0.8)]" />
                  </div>
                )}
          ...
          {capturedImage ? (
            ...
            <div className="mt-6 flex w-full gap-3">
              ...
              <Button
                ...
                className="flex-1 flex items-center gap-2 bg-primary py-6 text-base font-semibold text-primary-foreground hover:bg-primary/90 hover:shadow-[0_0_30px_rgba(201,144,69,0.5)]"
              >
            ...
            <Button
              ...
              className="mt-6 flex items-center gap-2 bg-primary px-8 py-6 text-lg font-semibold text-primary-foreground transition-all hover:bg-primary/90 hover:shadow-[0_0_30px_rgba(201,144,69,0.5)] disabled:opacity-50"
            >
              <Camera className="h-5 w-5" />
              Capture
            </Button>
