...
const problemLabels: Record<string, string> = {
  ...
  "dandruff-scalp-concerns": "Dandruff & Scalp Concerns",
  "patchy-hair-loss": "Patchy Hair Loss",
  "weak-low-density-hair": "Weak or Low-Density Hair",
  "excessive-shedding": "Excessive Shedding",
  // legacy values kept for previously submitted leads
...
export async function ScanDashboard({
  ...
  return (
    <main className="hairscan-theme min-h-screen bg-background p-6">
